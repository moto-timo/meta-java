...
SUMMARY = "meta-java ptest test image"

DESCRIPTION += "Also including the ${MCNAME} ptest package."
HOMEPAGE = "https://www.openembedded.org/"

PTESTS_META_JAVA = "${PTESTS_SLOW_META_JAVA} ${PTESTS_FAST_META_JAVA} ${PTESTS_PROBLEMS_META_JAVA}"

IMAGE_INSTALL:append = " ${MCNAME}-ptest openssh"

BBCLASSEXTEND = "${@' '.join(['mcextend:'+x for x in d.getVar('PTESTS_META_JAVA').split()])}"
